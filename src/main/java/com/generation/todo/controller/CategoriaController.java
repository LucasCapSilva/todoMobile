...
import com.generation.todo.repository.CategoriaRepository;
...
public class CategoriaController {
   ...
   public ResponseEntity<Categoria> put (@Valid @RequestBody Categoria categoria){
	   return repository.findById(categoria.getId()).map(resp -> ResponseEntity.ok(repository.save(categoria)))
